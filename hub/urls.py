...
urlpatterns = [
    ...
    path('vendor/profile/<int:vendor_id>/', views.vendor_detail_view, name='vendor_detail'),
    ...
    path('worker-profile/<int:pk>/', views.worker_profile_detail, name='worker_detail'),
    ...
    path('worker/<int:pk>/resume-preview/', views.worker_resume_preview, name='worker_resume_preview'),
    ...
    path('worker/<int:pk>/comment/', views.add_comment_to_worker, name='add_comment_to_worker'),
    path('job/<int:job_id>/comment/', views.add_comment, name='add_job_comment'),
    path('worker/<int:worker_id>/comment/', views.add_comment, name='add_worker_comment'),
    path('messaging/', views.messaging, name='messaging'),
    path('vendor-profile/<int:pk>/', views.vendor_profile_detail, name='vendor_profile_detail'),
    path('follow/<int:vendor_id>/', views.toggle_follow, name='toggle_follow'),
    path('get-new-messages/<int:receiver_id>/', views.get_new_messages, name='get_new_messages'),
    path('delete-message/<int:message_id>/', views.delete_message, name='delete_message'),
    path('load-more-messages/<int:receiver_id>/', views.load_more_messages, name='load_more_messages'),
    path('feature-job/<int:job_id>/', views.feature_job, name='feature_job'),
    path('auto-shortlist/<int:job_id>/', views.auto_shortlist_applicants, name='auto_shortlist'),
    ...
    path('get-new-messages/<int:user_id>/', views.get_new_messages, name='get_new_messages'),
    ...
    path('accept-invite/<int:notification_id>/', views.accept_invite, name='accept_invite'),
    ...
    path('worker/<int:pk>/generate-pdf/', views.generate_pdf, name='generate_pdf'),
]